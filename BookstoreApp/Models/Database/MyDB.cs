...
namespace BookstoreApp.Models.Database
{
    public class MyDB
    {
        ...
        private MyDB()
        {
            ...
            _connection = new SqlConnection(@"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=Bookstore;Data Source=AZIZ-PC;MultipleActiveResultSets=true");
        }
